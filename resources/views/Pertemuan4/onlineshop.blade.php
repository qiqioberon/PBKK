            ...
            @foreach ($products as $product)
                <div class="card flex flex-col gap-4 items-center justify-center shadow-xl p-6 rounded-xl">
                    ...
                    <div class="image w-[200px] h-[200px]">
                        <img src="{{ Vite::asset($product->image) }}" alt="{{ $product->name }}" class="w-full h-full" />
                    </div>
                    ...
                    <div class="plusminus flex flex-row justify-center items-start h-9">
                        <button id="minus" class="px-4 py-1 flex justify-center items-center border rounded-l-lg h-full hover:bg-black/20">
                        ...
                        <button id="plus" class="px-4 py-1 flex justify-center items-center border rounded-r-lg h-full hover:bg-black/20">
